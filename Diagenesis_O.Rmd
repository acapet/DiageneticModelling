...
$$\frac{\partial O_2(z)}{\partial t}=\frac{\partial O_2(z)}{\partial t}|_{trasnport}-\gamma(z)$$
...
$$ O_2(z=0) = O_{2, bottom} $$
* nul gradient at the lower cell $$ \frac{\partial O_2}{\partial z}|_{(z=sediment~bottom)}=0$$
